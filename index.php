...
<body style="background-color: #bce8f4;">
<div class="container" style="margin-top: 25px">
    <form action="#" method="POST">
        <input type="submit" class="btn btn-danger btn-lg" name="delete" value="Usun zadania">
    </form>
</div>
<div class="container" style="margin-top: 25px">
        <form action="addTask.php" method="POST">
            <input type="submit" class="btn btn-info btn-lg" name="addTask" value="Dodaj zadanie">
            <input type="submit" class="btn btn-info btn-lg" name="addPriorytyTask" value="Dodaj zadanie z priorytetem">
            <input type="submit" class="btn btn-info btn-lg" name="addDatePriorytyTask" value="Dodaj zadanie z priorytetem i terminem">
        </form>
